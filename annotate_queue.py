...
# Guarded on __main__ rather than executed unconditionally because
# check_segment_mask.py does `from annotate_queue import decode_rle` — an
# unconditional module-level exit would break that importer, which is not what
# this freeze is for. Running this file as a script is what must refuse.
if __name__ == "__main__":
    import sys as _sys

    _sys.stderr.write("""
================================================================================
FROZEN — annotate_queue.py will not run.  (audit finding C28)
================================================================================
...
The same join exists in this file: load_masks() builds
{m["segment_id"]: m for m in masks} from masks.json and writes labels into
the same annotations.json, so it inherits C28 identically.
